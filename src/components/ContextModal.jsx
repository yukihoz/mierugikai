    ...
    return (
        ...
        >
            ...
            >
                {/* Resting Character */}
                <img
                    src={`${import.meta.env.BASE_URL}images/gijie_nekorobu3.png`}
                    alt=""
                    className="absolute bottom-full right-8 md:right-16 h-20 w-auto object-contain z-10 drop-shadow-md mb-[-2px]"
                />
